...
$mensagem_email= $ip." , Falhou ao tentar logar no sistema de gestão de Tecnologia, verifique!!!";
$recebe_email = "ti@auditar.com.br";
mail($recebe_email,"Falha de login no sistema de gestão de Tecnologia!!!",$mensagem_email ) ;
